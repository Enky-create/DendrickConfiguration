        ...
        window-rules = [
          {
            ...
            # прямоугольник ПОЗАДИ окна, и он просвечивает сквозь полупрозрачные
            # окна (например kitty), когда они в фокусе.
            draw-border-with-background = false;

            # Скругление углов. niri не поддерживает проценты, только
            # логические пиксели. 12px — значение из офиц. примера,
            # подберите под себя.
            geometry-corner-radius = 12;
            # Без clip-to-geometry скругление только "говорит" рамке/тени,
            # какой радиус учитывать, но само содержимое окна не обрезается.
